...
public class PersonServiceApproach8 {
...
@Test
 public void testPersonService() {
	  personService.processElements(persons,
			   (Person p1)-> { return p1.getAge()>=10 && p1.getGender().equals(Person.Sex.MALE);}, 		  
			  (Person p2)-> {return p2.getName()+": "+p2.getEmailAddress();},			  
